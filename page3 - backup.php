            ...
            <!-- ---------------------------DANE POJAZDU START ----------------------  -->
                <fieldset><legend>Ubezpieczany pojazd</legend>
                    ...
                    <label class="formularz">Numer VIN:</label>
                        <input type="text" name="ocacNumVin" placeholder="17 znaków" pattern="[^.;()*& -^%$#@!{}\[\]]{17}" title="Numer VIN składający się z 17 znaków."  size="20" value="<?php echo $ocacNumVin; ?>">       
                    ...
                    <label class="formularz">Aktualny przebieg w tyś km</label>
                        <input type="text" name="ocacAktPrz" pattern="[0-9]{4,}" placeholder="przebieg w tyś km" required value="<?php echo $ocacAktPrz; ?>"><br>
...
--------------Pytania dotyczace wlasciciela
Imie głownego wlasciela
Nazwisko glownego wlasciela
Pesel glownego wlasciela
Numer telfonu
Aders email glownego wlasciela
Data urodzin wlasciela
Czy wlasciciel bedzie kierowal tym autem - select
Czy wlasciel posiada prawo jazdy kategorii B
Data uzyskania prawa jazdy kategori B wlasciciela
Kod pocztowy z adresu zamieszkania wlasciela
Miejscowosc

Czy adres zameldowania jest taki sam jak zamieszkania?

Pleć właścicela Kobieta/Mezczyzna
Stan cywilny wlasciciela
Czy wlasciciel posiada dzieci w wieku ponizej 26 lat?

Zawod wykonywany przez właściciela - pole select
Ilu wspolwlascicieli posiada pojazd 0/1/2i wiecej
Zgadzam sie na polityke prywatnosci wszystkich obsługiwanych TU - check

-------------------------Dodatkowi kierowcy
Czy beda dodatkowi kierowcy mlodsi od wymienionych lub posiadajacy prawo jazdy krocej niz 3 lata - nie, nie bedzie/ tak jeden / tak, dwoch lub wiecej

--------------------------Pytania dotyczace ubezpieczenia wlasciciela
Od ilu lat wlasciciel kupuje polisy OC dla swoich pojazdow SELECT
